...
<div class="banner-area-one shape-move">
                ...
                <div class="banner-content-one">
                    <div class="inner">
                        ...
                        <div class="banner-btn-author-wrapper">
                            <a href="course-five.html" class="rts-btn btn-primary with-arrow">View All Course <i
                            ...
                            <div class="sm-image-wrapper">
                                <div class="images-wrap">
                                    ...
                                    <img class="three" src="{{ asset('assets/images/banner/shape/08.png')}}"
                                        alt="banner">
                                </div>
                                <div class="info">
    ...
    <div class="shape-image">
        <div class="shape one" data-speed="0.04" data-revert="true"><img
                src="{{ asset('assets/images/banner/shape/banner-shape01.svg')}}" alt="shape_image"></div>
        <div class="shape two" data-speed="0.04"><img src="{{ asset('assets/images/banner/shape/banner-shape02.svg')}}"
                alt="shape_image"></div>
        <div class="shape three" data-speed="0.04"><img
                src="{{ asset('assets/images/banner/shape/banner-shape03.svg')}}" alt="shape_image"></div>
    </div>
</div>
