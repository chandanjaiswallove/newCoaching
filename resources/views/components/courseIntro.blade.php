    ...
    <div class="container">
        <div class="row align-items-center">
                ...
                <div class="why-choose-us-area-image pb--50">
                    ...
                    <div class="circle-animation">
                        <a class="uni-circle-text uk-background-white dark:uk-background-gray-80 uk-box-shadow-large uk-visible@m"
                            href="index.html#view_in_opensea">
            ...
            <div class="col-lg-6 pl--90 pl_md--15 mt_md--50 pl_sm--15 pt_sm--50">
                ...
                <a href="single-course.html" class="rts-btn btn-primary-white with-arrow">View All Course <i
                        class="fa-regular fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
    <div class="shape-image">
        <div class="shape one" data-speed="0.04" data-revert="true"><img src="{{ asset('assets/images/banner/15.png')}}"
                alt=""></div>
        <div class="shape two" data-speed="0.04"><img
                src="{{ asset('assets/images/banner/shape/banner-shape02-w.svg')}}" alt=""></div>
